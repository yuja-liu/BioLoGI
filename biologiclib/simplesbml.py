...
class sbmlModel(object):
    ...
    def __init__(self, time_units='second', extent_units='mole', \
        ...
        ##############################
        # Start of customized literal units
        # mole liter-1 second-1
        molar_per_second = self.model.createUnitDefinition()
        self.check(molar_per_second,                         'create unit definition')
        self.check(molar_per_second.setId('molar_per_second'),     'set unit definition id')
        ...
        # mole liter-1 (molar)
        molar = self.model.createUnitDefinition()
        self.check(molar,                         'create unit definition')
        self.check(molar.setId('molar'),     'set unit definition id')
